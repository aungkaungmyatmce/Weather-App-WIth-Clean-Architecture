...
class ThemeText {
  ...
  static TextStyle? get _whiteHeadline10 =>
  ...
  static TextStyle? get whiteSubtitle2 =>
      _poppinsTextTheme.titleMedium?.copyWith(
        fontSize: Sizes.dimen_12.sp.toDouble(),
        color: Colors.white,
      );
